...
test("repository manifest inventories every planned formal list", () => {
  const expectedIDs = [
    ...
    "project-overview.attention-actions",
    "project-overview.evidence-preview",
    ...
    "skill-aggregate-detail.actions",
    "skill-aggregate-detail.evidence",
    "skill-aggregate-detail.instances",
    "skill-aggregate-detail.state-counts",
