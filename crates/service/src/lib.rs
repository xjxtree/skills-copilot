...
use skills_copilot_commands::{
    ...
    authorized_file_watch_plan, clear_finding_triage, clear_rule_severity_override,
    clear_rule_suppression, commit_prepared_claude_settings_save, delete_local_skill_with_manager,
    ...
    inspect_local_source_with_manager, install_skill_from_tool_global, list_adapter_capabilities,
    list_adapter_diagnostics, list_agent_config_snapshot_page_snapshot,
    list_agent_config_snapshots, list_conflicts_for_context, list_finding_triage, list_findings,
    ...
    toggle_skill, user_visible_rule_findings, AdapterCapabilityRecord, AdapterDiagnosticsRecord,
    AgentCatalogScanPathAlias, AgentCatalogScanReport, AuthorizedFileWatchPlan,
    ...
    SkillInstallPreviewRecord, SkillManagerDeleteLocalParams, SkillManagerInspectLocalSourceParams,
    ...
    SkillManagerUpdateParams, SnapshotRollbackPreviewRecord, ToolGlobalImportResult,
...
pub struct AppStateSnapshot {
    ...
    pub watch_plan: AuthorizedFileWatchPlan,
