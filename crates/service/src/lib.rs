...
use skills_copilot_commands::{
    ...
    delete_local_skill_with_manager, export_skill_bundle, export_staging_skill_bundle, get_skill,
    ...
    save_claude_settings, scan_all_catalog_report, scan_claude_to_catalog,
    search_skills_with_manager, set_finding_triage, set_rule_severity_override,
    set_rule_suppression, skill_health_summary, toggle_skill, AdapterCapabilityRecord,
    AdapterDiagnosticsRecord, AgentCatalogScanReport, BatchToggleApplyRecord,
