        ...
        case "$input" in
          ...
          *\\"llm.previewSaveProviderProfile\\"*)
            if [ "$scenario" = "provider-action-ready" ]; then
              respond '{"id":"test","ok":true,"result":{"action":{"id":"provider-save-action","kind":"provider_settings","intent":"save_provider_profile","target":{"kind":"provider_profile","id":"openai-compatible","agent":null,"scope":"provider-global"},"project_id":null,"impacts":["credential_store","app_local_data"],"preview_method":"llm.previewSaveProviderProfile","apply_method":"llm.saveProviderProfile","source_revision":"sha256:provider-save","confirmation_required":true,"network":"none","readback":["provider_profiles"],"evidence_refs":["provider-profile:openai-compatible"]},"preconditions":[{"kind":"provider_profile","target_id":"openai-compatible","expected_revision":"sha256:profile-before"}],"preview_token":"action-preview:v1:hmac-sha256:provider-save-fixture","operation":"save","profile_id":"openai-compatible","provider_type":"openai-compatible","destination_host":"provider-action.example.com","model":"model-action","expected_revision":"sha256:profile-before","credential_change":true,"raw_secret_returned":false}}'
            fi
          ...
          *\\"llm.saveProviderProfile\\"*)
            if [ "$scenario" = "provider-action-ready" ]; then
              respond '{"id":"test","ok":true,"result":{"profile":null,"readback":{"action_id":"provider-save-action","source_revision":"sha256:provider-save-after","project_id":null,"domains":["provider_profiles"],"target_ids":["openai-compatible"],"observations":[{"domain":"provider_profiles","target_id":"openai-compatible","revision":"sha256:profile-after"}],"verified":true}}}'
            fi
            if [ "$scenario" = "autosave-delayed-provider" ] || [ "$scenario" = "autosave-delayed-provider-failure" ]; then
          ...
          *\\"llm.previewDeleteProviderProfile\\"*)
            if [ "$scenario" = "provider-action-ready" ]; then
              respond '{"id":"test","ok":true,"result":{"action":{"id":"provider-delete-action","kind":"provider_settings","intent":"delete_provider_profile","target":{"kind":"provider_profile","id":"openai-compatible","agent":null,"scope":"provider-global"},"project_id":null,"impacts":["credential_store","app_local_data"],"preview_method":"llm.previewDeleteProviderProfile","apply_method":"llm.deleteProviderProfile","source_revision":"sha256:provider-delete","confirmation_required":true,"network":"none","readback":["provider_profiles"],"evidence_refs":["provider-profile:openai-compatible"]},"preconditions":[{"kind":"provider_profile","target_id":"openai-compatible","expected_revision":"sha256:profile-before"}],"preview_token":"action-preview:v1:hmac-sha256:provider-delete-fixture","operation":"delete","profile_id":"openai-compatible","provider_type":"openai-compatible","destination_host":"provider-action.example.com","model":"model-action","expected_revision":"sha256:profile-before","credential_change":true,"raw_secret_returned":false}}'
            fi
          ...
          *\\"llm.deleteProviderProfile\\"*)
            if [ "$scenario" = "provider-action-ready" ]; then
              respond '{"id":"test","ok":true,"result":{"deleted_profile_id":"openai-compatible","profile_deleted":true,"credential_deleted":true,"raw_secret_returned":false,"readback":{"action_id":"provider-delete-action","source_revision":"sha256:provider-delete-after","project_id":null,"domains":["provider_profiles"],"target_ids":["openai-compatible"],"observations":[{"domain":"provider_profiles","target_id":"openai-compatible","revision":"sha256:profile-deleted"}],"verified":true}}}'
            fi
          ...
          *\\"llm.previewProviderConnectionTest\\"*)
            if [ "$scenario" = "provider-action-ready" ]; then
              respond '{"id":"test","ok":true,"result":{"action":{"id":"provider-test-action","kind":"provider_settings","intent":"test_provider_connection","target":{"kind":"provider_profile","id":"openai-compatible","agent":null,"scope":"provider-global"},"project_id":null,"impacts":["external_network","app_local_data"],"preview_method":"llm.previewProviderConnectionTest","apply_method":"llm.testProviderConnection","source_revision":"sha256:provider-test","confirmation_required":true,"network":"external","readback":["provider_activity"],"evidence_refs":["provider-profile:openai-compatible"]},"preconditions":[{"kind":"provider_profile","target_id":"openai-compatible","expected_revision":"sha256:profile-before"}],"preview_token":"action-preview:v1:hmac-sha256:provider-test-fixture","operation":"test","profile_id":"openai-compatible","provider_type":"openai-compatible","destination_host":"provider-action.example.com","model":"model-action","expected_revision":"sha256:profile-before","credential_change":false,"raw_secret_returned":false}}'
            fi
          ...
          *\\"llm.testProviderConnection\\"*)
            if [ "$scenario" = "provider-action-ready" ]; then
              respond '{"id":"test","ok":true,"result":{"success":true,"status":"succeeded","message":"Provider connection succeeded.","audit_metadata":{"request_id":"provider-test-action","status":"succeeded","provider":"openai-compatible","model":"model-action","destination_host":"provider-action.example.com","redaction_applied":true,"raw_prompt_persisted":false,"raw_response_persisted":false},"readback":{"action_id":"provider-test-action","source_revision":"sha256:provider-test-after","project_id":null,"domains":["provider_activity"],"target_ids":["provider-test-action"],"observations":[{"domain":"provider_activity","target_id":"provider-test-action","revision":"sha256:activity-after"}],"verified":true}}}'
            fi
          ...
          *\\"llm.previewPrompt\\"*)
            if [ "$scenario" = "prompt-ready" ] || [ "$scenario" = "slow-task-cockpit" ]; then
              if printf '%s' "$input" | grep -q '\\"request_kind\\":\\"task_cockpit\\"'; then
                respond '{"id":"test","ok":true,"result":{"preview_id":"task-cockpit-preview","request_kind":"task_cockpit","action":{"id":"task-cockpit-preview","kind":"provider_prompt","intent":"send_provider_prompt","target":{"kind":"provider_profile","id":"openai-compatible","agent":null,"scope":"provider-global"},"project_id":null,"impacts":["external_network","app_local_data"],"preview_method":"llm.previewPrompt","apply_method":"llm.confirmPromptAndSend","source_revision":"sha256:task-cockpit-preview","confirmation_required":true,"network":"external","readback":["provider_activity","prompt_runs"],"evidence_refs":["provider-profile:openai-compatible"]},"preconditions":[{"kind":"provider_profile","target_id":"openai-compatible","expected_revision":"sha256:profile"}],"preview_token":"action-preview:v1:hmac-sha256:task-cockpit-fixture","scope":"agents","prompt_scope":"Task preflight for selected agents","enabled":true,"provider":"openai-compatible","model":"gpt-5","destination_host":"llm.example.com","included_fields":["task.text","agents","effective_skills"],"excluded_fields":[{"name":"skill.body","reason":"raw body omitted"},{"name":"agent.config","reason":"config contents omitted"},{"name":"api_key","reason":"credential redacted"}],"redaction":{"status":"redacted","summary":"Secrets, raw bodies, config contents, and local paths removed.","redacted_fields":["api_key","path","skill.body","agent.config"],"placeholders":["<project-root>"]},"estimate":{"input_tokens":520,"output_tokens":240,"total_tokens":760,"estimated_cost_usd":0.008},"confirmation_required":true,"raw_prompt_persisted":false,"raw_response_persisted":false,"draft_copy_only":true,"redacted_prompt_preview":"Task preflight from selected agent and effective skill metadata."}}'
              fi
            fi
            if [ "$scenario" = "prompt-ready" ]; then
              respond '{"id":"test","ok":true,"result":{"preview_id":"prompt-preview-beta","request_kind":"action","action":{"id":"prompt-preview-beta","kind":"provider_prompt","intent":"send_provider_prompt","target":{"kind":"provider_profile","id":"openai-compatible","agent":null,"scope":"provider-global"},"project_id":null,"impacts":["external_network","app_local_data"],"preview_method":"llm.previewPrompt","apply_method":"llm.confirmPromptAndSend","source_revision":"sha256:prompt-preview-beta","confirmation_required":true,"network":"external","readback":["provider_activity","prompt_runs"],"evidence_refs":["provider-profile:openai-compatible"]},"preconditions":[{"kind":"provider_profile","target_id":"openai-compatible","expected_revision":"sha256:profile"}],"preview_token":"action-preview:v1:hmac-sha256:prompt-beta-fixture","scope":"selected","prompt_scope":"Selected skill analysis for Beta","enabled":true,"provider":"openai-compatible","model":"gpt-5","destination_host":"llm.example.com","included_fields":["skill.name","findings.summary"],"excluded_fields":[{"name":"api_key","reason":"credential redacted"}],"redaction":{"status":"redacted","summary":"Secrets and local paths removed.","redacted_fields":["api_key"],"placeholders":["<project-root>"]},"estimate":{"input_tokens":240,"output_tokens":120,"total_tokens":360,"estimated_cost_usd":0.0042},"confirmation_required":true,"raw_prompt_persisted":false,"raw_response_persisted":false,"draft_copy_only":true,"redacted_prompt_preview":"Analyze Beta using catalog metadata and finding summaries only."}}'
            fi
          ...
          *\\"project.removeRecentContext\\"*)
            respond '{"id":"test","ok":true,"result":{"active":'"$project_active"',"recent":[{"id":"project-2","name":"Other Project","root_path":"/tmp/other","current_cwd":"/tmp/other","last_used_at":"2026-06-07T00:00:00Z","is_active":false,"validation_error":null}]}}'
            ;;
          *\\"project.clearRecentContexts\\"*)
            respond '{"id":"test","ok":true,"result":{"active":'"$project_active"',"recent":[]}}'
            ;;
