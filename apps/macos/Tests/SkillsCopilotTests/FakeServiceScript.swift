    ...
    private var script: String {
        ...
        case "$input" in
          ...
          *\\"catalog.scanAll\\"*)
            ...
            respond '{"id":"test","ok":true,"result":{"scanned_count":3,"skills":'"$scan_skills"',"activity":{"operation":"scan","status":"completed-partial","started_at":1,"finished_at":2,"scanned_count":3,"skill_count":3,"finding_count":'"$scan_finding_count"',"conflict_count":0,"snapshot_count":0,"roots":["/tmp/global","/tmp/codex"],"log_entries":[],"recovery_actions":[],"agent_summaries":[{"agent":"claude-code","display_label":"Claude Code","status":"completed-partial","scanned_count":2,"catalog_count":2,"broken_count":0,"roots_considered":["<adapter-root>","/tmp/missing-claude"],"roots_scanned":["/tmp/global"],"roots_partial":["<adapter-root>"],"roots_skipped":["/tmp/missing-claude"],"scan_issues":[{"kind":"entry_unreadable","path":"<adapter-root>/dangling-link","detail":"A directory entry could not be inspected or resolved."}],"recovery_actions":["Review partial scan diagnostics."]},{"agent":"codex","display_label":"Codex","status":"completed","scanned_count":1,"catalog_count":1,"broken_count":0,"roots_considered":["/tmp/codex"],"roots_scanned":["/tmp/codex"],"roots_partial":[],"roots_skipped":[],"scan_issues":[],"recovery_actions":[]}]}}}'
            ;;
          *\\"project.getContext\\"*)
