    ...
    private var script: String {
        ...
        case "$input" in
          ...
          *\\"batch.applySkillToggles\\"*)
            ...
            elif [ "$scenario" = "toggle-disabled" ] || [ "$scenario" = "stale-after-toggle" ] || [ "$scenario" = "toggle-codex-disabled" ] || [ "$scenario" = "opencode" ]; then
              respond '{"id":"test","ok":true,"result":{"updated_count":1,"skipped_count":0,"snapshot_ids":["snap-single"]}}'
            fi
