...
final class FakeServiceScript: ServiceProcessRunning {
    ...
    private var script: String {
        ...
        status_response() {
          respond '{"id":"test","ok":true,"result":{"protocol_version":'"$protocol_version"', "version":"test","app_data_dir":"/tmp/skills-copilot","catalog_path":"/tmp/skills-copilot/catalog.sqlite","user_home":"/tmp/home","supported_methods":["app.stateSnapshot","service.status","privacy.inspectLegacyContent","privacy.previewCleanupLegacyContent","privacy.cleanupLegacyContent","catalog.listSkills","catalog.scanAll","catalog.getSkill","catalog.listFindings","catalog.listConflicts","skill.listEventsPage","snapshot.list","snapshot.listAgentConfigPage","snapshot.previewRollback","snapshot.rollback","config.toggleSkill","config.readAgentConfig","config.readClaudeSettings","config.previewSaveClaudeSettings","config.saveClaudeSettings","batch.previewSkillToggles","batch.applySkillToggles","project.getContext","project.previewSetContext","project.setContext","project.previewClearContext","project.clearContext","project.previewRemoveRecentContext","project.removeRecentContext","project.previewClearRecentContexts","project.clearRecentContexts","project.validateContext"],"adapter_capabilities":'"$adapter_capabilities"'}}'
        }
        ...
        project_action_set_invalid='{"id":"action:set-project","kind":"project_context","intent":"set_project_context","target":{"kind":"project","id":"project-missing"},"project_id":"project-missing","impacts":["app_local_data"],"preview_method":"project.previewSetContext","apply_method":"project.setContext","source_revision":"sha256:project-set-source","confirmation_required":true,"network":"none","readback":["project_context"],"evidence_refs":["project-context-state:sha256:project-before"]}'
        ...
        config_save_action='{"id":"action:save_config:global","kind":"save_config","intent":"save_config","target":{"kind":"config","id":"/tmp/home/.claude/settings.json","agent":"claude-code","scope":"agent-global"},"project_id":null,"impacts":["agent_config","app_local_data"],"preview_method":"config.previewSaveClaudeSettings","apply_method":"config.saveClaudeSettings","source_revision":"sha256:settings-revision","confirmation_required":true,"network":"none","readback":["catalog_skills","skill_aggregates","agent_config","config_snapshots"],"evidence_refs":["config:/tmp/home/.claude/settings.json"]}'
        rollback_action_global='{"id":"action:rollback_config:global","kind":"rollback_config","intent":"rollback_config","target":{"kind":"config","id":"/tmp/home/.claude/settings.json","agent":"claude-code","scope":"agent-global"},"project_id":null,"impacts":["agent_config","app_local_data"],"preview_method":"snapshot.previewRollback","apply_method":"snapshot.rollback","source_revision":"sha256:rollback-global-source","confirmation_required":true,"network":"none","readback":["catalog_skills","skill_aggregates","agent_config"],"evidence_refs":["snapshot:snap-claude-new","config:/tmp/home/.claude/settings.json"]}'
        rollback_action_project='{"id":"action:rollback_config:project","kind":"rollback_config","intent":"rollback_config","target":{"kind":"config","id":"/tmp/project/.claude/settings.local.json","agent":"claude-code","scope":"agent-project"},"project_id":"project-fixture","impacts":["agent_config","app_local_data"],"preview_method":"snapshot.previewRollback","apply_method":"snapshot.rollback","source_revision":"sha256:rollback-project-source","confirmation_required":true,"network":"none","readback":["catalog_skills","skill_aggregates","agent_config"],"evidence_refs":["snapshot:snap-claude-old","config:/tmp/project/.claude/settings.local.json"]}'
        ...
        case "$input" in
          ...
          *\\"privacy.inspectLegacyContent\\"*)
            if [ "$scenario" = "privacy-cleanup" ] && ! grep -q '"method":"privacy.cleanupLegacyContent"' "$SKILLS_COPILOT_FAKE_SERVICE_CALLS"; then
              respond '{"id":"test","ok":true,"result":{"generated_by":"local-v2.64","cleanup_required":true,"cleanup_source_count":2,"existing_source_count":2,"sources":[{"id":"prompt-runs","source_file":"prompt-runs.json","item_type":"regular_file","state":"legacy_private_content","cleanup_operation":"sanitize_metadata","cleanup_required":true,"malformed":false,"generated_residue":false},{"id":"task-preflight-history","source_file":"task-preflight-history.json","item_type":"regular_file","state":"legacy_private_content","cleanup_operation":"delete_leaf","cleanup_required":true,"malformed":false,"generated_residue":false}],"read_only":true,"provider_request_sent":false,"raw_content_returned":false,"write_performed":false}}'
            fi
            respond '{"id":"test","ok":true,"result":{"generated_by":"local-v2.64","cleanup_required":false,"cleanup_source_count":0,"existing_source_count":0,"sources":[],"read_only":true,"provider_request_sent":false,"raw_content_returned":false,"write_performed":false}}'
            ;;
          *\\"privacy.previewCleanupLegacyContent\\"*)
            if [ "$scenario" = "privacy-cleanup" ]; then
              respond '{"id":"test","ok":true,"result":{"inspection":{"generated_by":"local-v2.64","cleanup_required":true,"cleanup_source_count":2,"existing_source_count":2,"sources":[{"id":"prompt-runs","source_file":"prompt-runs.json","item_type":"regular_file","state":"legacy_private_content","cleanup_operation":"sanitize_metadata","cleanup_required":true,"malformed":false,"generated_residue":false},{"id":"task-preflight-history","source_file":"task-preflight-history.json","item_type":"regular_file","state":"legacy_private_content","cleanup_operation":"delete_leaf","cleanup_required":true,"malformed":false,"generated_residue":false}],"read_only":true,"provider_request_sent":false,"raw_content_returned":false,"write_performed":false},"action":{"id":"privacy-cleanup-action","kind":"privacy_cleanup","intent":"clean_legacy_private_content","target":{"kind":"app_data","id":"legacy-ai-private-content","agent":null,"scope":null},"project_id":null,"impacts":["app_local_data"],"preview_method":"privacy.previewCleanupLegacyContent","apply_method":"privacy.cleanupLegacyContent","source_revision":"sha256:privacy-before","confirmation_required":true,"network":"none","readback":["private_content"],"evidence_refs":["app-data:legacy-ai-private-content"]},"preconditions":[{"kind":"legacy_private_content","target_id":"prompt-runs","expected_revision":"opaque-prompt-runs"},{"kind":"legacy_private_content","target_id":"task-preflight-history","expected_revision":"opaque-task-preflight"},{"kind":"prompt_context","target_id":"provider-action-state","expected_revision":"sha256:replay-before"}],"preview_token":"action-preview:v1:hmac-sha256:privacy-fixture","confirmation_required":true}}'
            fi
            respond '{"id":"test","ok":true,"result":{"inspection":{"generated_by":"local-v2.64","cleanup_required":false,"cleanup_source_count":0,"existing_source_count":0,"sources":[],"read_only":true,"provider_request_sent":false,"raw_content_returned":false,"write_performed":false},"action":null,"preconditions":[],"preview_token":null,"confirmation_required":false}}'
            ;;
          *\\"privacy.cleanupLegacyContent\\"*)
            if [ "$scenario" = "privacy-cleanup" ]; then
              respond '{"id":"test","ok":true,"result":{"inspection":{"generated_by":"local-v2.64","cleanup_required":false,"cleanup_source_count":0,"existing_source_count":1,"sources":[{"id":"prompt-runs","source_file":"prompt-runs.json","item_type":"regular_file","state":"current_metadata_only","cleanup_operation":"sanitize_metadata","cleanup_required":false,"malformed":false,"generated_residue":false}],"read_only":true,"provider_request_sent":false,"raw_content_returned":false,"write_performed":false},"cleaned_source_count":2,"state":"verified","effect":"legacy_private_content_removed_or_sanitized","retry_allowed":false,"readback":{"action_id":"privacy-cleanup-action","source_revision":"sha256:privacy-after","project_id":null,"domains":["private_content"],"target_ids":["legacy-ai-private-content"],"observations":[{"domain":"private_content","target_id":"legacy-ai-private-content","revision":"sha256:privacy-clean"}],"verified":true}}}'
            fi
            respond '{"id":"test","ok":false,"result":null,"error":{"code":"stale_action_reference","message":"stale action reference"}}'
            ;;
          *\\"rules.listTuning\\"*)
          ...
          *\\"llm.previewPrompt\\"*)
            if [ "$scenario" = "prompt-ready" ] || [ "$scenario" = "slow-task-cockpit" ]; then
              if printf '%s' "$input" | grep -q '\\"request_kind\\":\\"task_cockpit\\"'; then
                respond '{"id":"test","ok":true,"result":{"preview_id":"task-cockpit-preview","request_kind":"task_cockpit","action":{"id":"task-cockpit-preview","kind":"provider_prompt","intent":"send_provider_prompt","target":{"kind":"provider_profile","id":"openai-compatible","agent":null,"scope":null},"project_id":"project-fixture","impacts":["app_local_data"],"preview_method":"llm.previewPrompt","apply_method":"llm.confirmPromptAndSend","source_revision":"sha256:task-cockpit-preview","confirmation_required":true,"network":"required","readback":["provider_activity","prompt_runs"],"evidence_refs":["provider-profile:openai-compatible"]},"preconditions":[{"kind":"provider_profile","target_id":"provider-profiles","expected_revision":"sha256:profile"},{"kind":"prompt_context","target_id":"redacted-prompt","expected_revision":"sha256:redacted-task-cockpit"},{"kind":"prompt_context","target_id":"provider-action-state","expected_revision":"sha256:provider-action-state-before"},{"kind":"prompt_context","target_id":"product-evidence","expected_revision":"sha256:product-fixture"}],"preview_token":"action-preview:v1:hmac-sha256:task-cockpit-fixture","scope":"agents","prompt_scope":"Task preflight for selected agents","enabled":true,"provider":"openai-compatible","model":"gpt-5","destination_host":"llm.example.com","included_fields":["task.text","agents","effective_skills"],"excluded_fields":[{"name":"skill.body","reason":"raw body omitted"},{"name":"agent.config","reason":"config contents omitted"},{"name":"api_key","reason":"credential redacted"}],"redaction":{"status":"redacted","summary":"Secrets, raw bodies, config contents, and local paths removed.","redacted_fields":["api_key","path","skill.body","agent.config"],"placeholders":["<project-root>"]},"response_contract":{"schema_version":1,"request_kind":"task_cockpit","project_id":"project-fixture","source_revision":"sha256:product-fixture","result_schema":"task_readiness","evidence":[{"id":"evidence:project:fixture","kind":"project_context","source_revision":"sha256:product-fixture","summary":"Accepted project evidence.","agent":null,"target_id":"project-fixture"}],"actions":[],"required_safety_flags":{"copy_only":true,"write_back_allowed":false,"command_execution_allowed":false,"script_execution_allowed":false,"mutation_allowed":false,"hidden_task_state_created":false,"raw_prompt_persisted":false,"raw_response_persisted":false,"raw_trace_persisted":false}},"estimate":{"input_tokens":520,"output_tokens":240,"total_tokens":760,"estimated_cost_usd":0.008},"confirmation_required":true,"raw_prompt_persisted":false,"raw_response_persisted":false,"draft_copy_only":true,"redacted_prompt_preview":"Task preflight from selected agent and effective skill metadata."}}'
              fi
            fi
            if [ "$scenario" = "prompt-ready" ]; then
              respond '{"id":"test","ok":true,"result":{"preview_id":"prompt-preview-beta","request_kind":"analyze","action":{"id":"prompt-preview-beta","kind":"provider_prompt","intent":"send_provider_prompt","target":{"kind":"provider_profile","id":"openai-compatible","agent":null,"scope":null},"project_id":"project-fixture","impacts":["app_local_data"],"preview_method":"llm.previewPrompt","apply_method":"llm.confirmPromptAndSend","source_revision":"sha256:prompt-preview-beta","confirmation_required":true,"network":"required","readback":["provider_activity","prompt_runs"],"evidence_refs":["provider-profile:openai-compatible"]},"preconditions":[{"kind":"provider_profile","target_id":"provider-profiles","expected_revision":"sha256:profile"},{"kind":"prompt_context","target_id":"redacted-prompt","expected_revision":"sha256:redacted-prompt-beta"},{"kind":"prompt_context","target_id":"provider-action-state","expected_revision":"sha256:provider-action-state-before"},{"kind":"prompt_context","target_id":"product-evidence","expected_revision":"sha256:product-fixture"}],"preview_token":"action-preview:v1:hmac-sha256:prompt-beta-fixture","scope":"selected","prompt_scope":"Selected skill analysis for Beta","enabled":true,"provider":"openai-compatible","model":"gpt-5","destination_host":"llm.example.com","included_fields":["skill.name","findings.summary"],"excluded_fields":[{"name":"api_key","reason":"credential redacted"}],"redaction":{"status":"redacted","summary":"Secrets and local paths removed.","redacted_fields":["api_key"],"placeholders":["<project-root>"]},"response_contract":{"schema_version":1,"request_kind":"analyze","project_id":"project-fixture","source_revision":"sha256:product-fixture","result_schema":"copy_only_markdown","evidence":[{"id":"evidence:project:fixture","kind":"project_context","source_revision":"sha256:product-fixture","summary":"Accepted project evidence.","agent":null,"target_id":"project-fixture"}],"actions":[],"required_safety_flags":{"copy_only":true,"write_back_allowed":false,"command_execution_allowed":false,"script_execution_allowed":false,"mutation_allowed":false,"hidden_task_state_created":false,"raw_prompt_persisted":false,"raw_response_persisted":false,"raw_trace_persisted":false}},"estimate":{"input_tokens":240,"output_tokens":120,"total_tokens":360,"estimated_cost_usd":0.0042},"confirmation_required":true,"raw_prompt_persisted":false,"raw_response_persisted":false,"draft_copy_only":true,"redacted_prompt_preview":"Analyze Beta using catalog metadata and finding summaries only."}}'
            fi
          ...
          *\\"llm.confirmPromptAndSend\\"*)
            if [ "$scenario" = "slow-task-cockpit" ]; then
              if printf '%s' "$input" | grep -q '\\"request_kind\\":\\"task_cockpit\\"'; then
                sleep 1
                respond '{"id":"test","ok":true,"result":{"preview_id":"task-cockpit-preview","status":"succeeded","message":"Provider response received.","response_envelope":{"schema_version":1,"request_kind":"task_cockpit","project_id":"project-fixture","source_revision":"sha256:product-fixture","result_schema":"task_readiness","evidence_refs":["evidence:project:fixture"],"action_refs":[],"result":{"summary":{"summary":"Ready","recommended_agent":"claude-code","recommended_skill_name":"Beta","readiness_score":80,"routing_score":75,"gap_count":0,"blocker_count":0},"agent_candidates":[{"id":"agent-claude","rank":1,"title":"Claude Code","agent":"claude-code","score":88}],"skill_candidates":[{"id":"skill:beta","rank":1,"title":"Beta","agent":"claude-code","skill":{"instance_id":"beta","name":"Beta","agent":"claude-code","definition_id":"def.beta"},"routing_score":88,"readiness_score":80},{"id":"skill:alpha","rank":2,"title":"Alpha","agent":"claude-code","skill":{"instance_id":"alpha","name":"Alpha","agent":"claude-code","definition_id":"def.alpha"},"routing_score":64,"readiness_score":70}],"readiness_signals":[{"id":"readiness-beta","title":"Provider readiness","detail":"Ready for local audit.","status":"review","agent":"claude-code"}],"gap_rows":[{"id":"gap-codex","title":"Codex coverage not selected","detail":"Selected scope only includes Claude Code.","severity":"info","agent":"codex"}],"blocker_rows":[]},"safety_flags":{"copy_only":true,"write_back_allowed":false,"command_execution_allowed":false,"script_execution_allowed":false,"mutation_allowed":false,"hidden_task_state_created":false,"raw_prompt_persisted":false,"raw_response_persisted":false,"raw_trace_persisted":false}},"output_text":"{\\"generated_by\\":\\"provider-task-cockpit\\",\\"catalog_available\\":true,\\"filters\\":{\\"task_text\\":\\"Prepare local release audit work.\\",\\"agents\\":[\\"claude-code\\"]},\\"summary\\":{\\"task_text\\":\\"Prepare local release audit work.\\",\\"summary\\":\\"Late slow result that should be ignored after timeout or cancel.\\",\\"recommended_agent\\":\\"claude-code\\",\\"recommended_skill_name\\":\\"Slow Beta\\",\\"readiness_score\\":61,\\"routing_score\\":62,\\"agent_candidate_count\\":1,\\"skill_candidate_count\\":1,\\"gap_count\\":0,\\"blocker_count\\":0},\\"agent_candidates\\":[{\\"id\\":\\"agent-claude\\",\\"rank\\":1,\\"title\\":\\"Claude Code\\",\\"agent\\":\\"claude-code\\",\\"score\\":62}],\\"skill_candidates\\":[{\\"id\\":\\"skill:beta\\",\\"rank\\":1,\\"title\\":\\"Slow Beta\\",\\"agent\\":\\"claude-code\\",\\"skill\\":{\\"instance_id\\":\\"beta\\",\\"name\\":\\"Slow Beta\\",\\"agent\\":\\"claude-code\\",\\"definition_id\\":\\"def.beta\\"},\\"routing_score\\":62,\\"readiness_score\\":61}],\\"safety_flags\\":{\\"provider_request_sent\\":true,\\"write_back_allowed\\":false,\\"script_execution_allowed\\":false,\\"raw_prompt_persisted\\":false,\\"raw_response_persisted\\":false}}","draft_copy_only":true,"raw_prompt_persisted":false,"raw_response_persisted":false,"write_back_allowed":false,"script_execution_allowed":false,"audit_metadata":{"request_id":"audit-task-cockpit-slow","status":"succeeded","provider":"openai-compatible","model":"gpt-5","destination_host":"llm.example.com","redaction_applied":true,"raw_prompt_persisted":false,"raw_response_persisted":false,"input_tokens":520,"output_tokens":180},"readback":{"action_id":"task-cockpit-preview","source_revision":"sha256:task-cockpit-after","project_id":"project-fixture","domains":["provider_activity","prompt_runs"],"target_ids":["task-cockpit-preview"],"observations":[{"domain":"provider_activity","target_id":"task-cockpit-preview","revision":"sha256:activity-after"},{"domain":"prompt_runs","target_id":"task-cockpit-preview","revision":"sha256:prompt-run-after"}],"verified":true}}}'
              fi
            fi
            if [ "$scenario" = "prompt-ready" ]; then
              if printf '%s' "$input" | grep -q '\\"request_kind\\":\\"task_cockpit\\"'; then
                respond '{"id":"test","ok":true,"result":{"preview_id":"task-cockpit-preview","status":"succeeded","message":"Provider response received.","response_envelope":{"schema_version":1,"request_kind":"task_cockpit","project_id":"project-fixture","source_revision":"sha256:product-fixture","result_schema":"task_readiness","evidence_refs":["evidence:project:fixture"],"action_refs":[],"result":{"summary":{"summary":"Ready","recommended_agent":"claude-code","recommended_skill_name":"Beta","readiness_score":80,"routing_score":75,"gap_count":0,"blocker_count":0},"agent_candidates":[{"id":"agent-claude","rank":1,"title":"Claude Code","agent":"claude-code","score":88}],"skill_candidates":[{"id":"skill:beta","rank":1,"title":"Beta","agent":"claude-code","skill":{"instance_id":"beta","name":"Beta","agent":"claude-code","definition_id":"def.beta"},"routing_score":88,"readiness_score":80},{"id":"skill:alpha","rank":2,"title":"Alpha","agent":"claude-code","skill":{"instance_id":"alpha","name":"Alpha","agent":"claude-code","definition_id":"def.alpha"},"routing_score":64,"readiness_score":70}],"readiness_signals":[{"id":"readiness-beta","title":"Provider readiness","detail":"Ready for local audit.","status":"review","agent":"claude-code"}],"gap_rows":[{"id":"gap-codex","title":"Codex coverage not selected","detail":"Selected scope only includes Claude Code.","severity":"info","agent":"codex"}],"blocker_rows":[]},"safety_flags":{"copy_only":true,"write_back_allowed":false,"command_execution_allowed":false,"script_execution_allowed":false,"mutation_allowed":false,"hidden_task_state_created":false,"raw_prompt_persisted":false,"raw_response_persisted":false,"raw_trace_persisted":false}},"output_text":"{\\"generated_by\\":\\"provider-task-cockpit\\",\\"catalog_available\\":true,\\"filters\\":{\\"task_text\\":\\"Prepare local release audit work.\\",\\"agents\\":[\\"claude-code\\"]},\\"summary\\":{\\"task_text\\":\\"Prepare local release audit work.\\",\\"summary\\":\\"Beta is the strongest provider-ranked route; confirm handoff boundaries.\\",\\"recommended_agent\\":\\"claude-code\\",\\"recommended_skill_name\\":\\"Beta\\",\\"readiness_score\\":78,\\"routing_score\\":88,\\"agent_candidate_count\\":1,\\"skill_candidate_count\\":2,\\"gap_count\\":1,\\"blocker_count\\":0},\\"agent_candidates\\":[{\\"id\\":\\"agent-claude\\",\\"rank\\":1,\\"title\\":\\"Claude Code\\",\\"agent\\":\\"claude-code\\",\\"score\\":82,\\"summary\\":\\"Selected agent has enabled matching skills.\\",\\"reasons\\":[\\"Effective skills include Beta.\\"]}],\\"skill_candidates\\":[{\\"id\\":\\"skill:beta\\",\\"rank\\":1,\\"title\\":\\"Beta\\",\\"agent\\":\\"claude-code\\",\\"skill\\":{\\"instance_id\\":\\"beta\\",\\"name\\":\\"Beta\\",\\"agent\\":\\"claude-code\\",\\"definition_id\\":\\"def.beta\\"},\\"readiness_score\\":78,\\"routing_score\\":88,\\"summary\\":\\"Best match for release audit.\\",\\"reasons\\":[\\"Description matches audit work.\\"]},{\\"id\\":\\"skill:alpha\\",\\"rank\\":2,\\"title\\":\\"Alpha\\",\\"agent\\":\\"claude-code\\",\\"skill\\":{\\"instance_id\\":\\"alpha\\",\\"name\\":\\"Alpha\\",\\"agent\\":\\"claude-code\\",\\"definition_id\\":\\"def.alpha\\"},\\"routing_score\\":64,\\"summary\\":\\"Similar audit wording.\\"}],\\"readiness_signals\\":[{\\"id\\":\\"readiness-beta\\",\\"title\\":\\"Provider readiness\\",\\"detail\\":\\"Ready for local audit, confirm handoff boundary.\\",\\"status\\":\\"review\\",\\"agent\\":\\"claude-code\\"}],\\"gap_rows\\":[{\\"id\\":\\"gap-codex\\",\\"title\\":\\"Codex coverage not selected\\",\\"detail\\":\\"Selected scope only includes Claude Code.\\",\\"severity\\":\\"info\\",\\"agent\\":\\"codex\\"}],\\"blocker_rows\\":[],\\"safety_flags\\":{\\"provider_request_sent\\":true,\\"write_back_allowed\\":false,\\"write_actions_available\\":false,\\"script_execution_allowed\\":false,\\"execution_actions_available\\":false,\\"config_mutation_allowed\\":false,\\"snapshot_created\\":false,\\"triage_mutation_allowed\\":false,\\"credential_accessed\\":false,\\"raw_prompt_persisted\\":false,\\"raw_response_persisted\\":false,\\"raw_trace_persisted\\":false,\\"cloud_sync_enabled\\":false,\\"telemetry_enabled\\":false,\\"raw_secret_returned\\":false,\\"notes\\":[\\"copy-only recommendation\\"]}}","draft_copy_only":true,"raw_prompt_persisted":false,"raw_response_persisted":false,"write_back_allowed":false,"script_execution_allowed":false,"audit_metadata":{"request_id":"audit-task-cockpit-1","status":"succeeded","provider":"openai-compatible","model":"gpt-5","destination_host":"llm.example.com","redaction_applied":true,"raw_prompt_persisted":false,"raw_response_persisted":false,"input_tokens":520,"output_tokens":180},"readback":{"action_id":"task-cockpit-preview","source_revision":"sha256:task-cockpit-after","project_id":"project-fixture","domains":["provider_activity","prompt_runs"],"target_ids":["task-cockpit-preview"],"observations":[{"domain":"provider_activity","target_id":"task-cockpit-preview","revision":"sha256:activity-after"},{"domain":"prompt_runs","target_id":"task-cockpit-preview","revision":"sha256:prompt-run-after"}],"verified":true}}}'
              fi
              respond '{"id":"test","ok":true,"result":{"preview_id":"prompt-preview-beta","status":"succeeded","message":"Provider response received.","response_envelope":{"schema_version":1,"request_kind":"analyze","project_id":"project-fixture","source_revision":"sha256:product-fixture","result_schema":"copy_only_markdown","evidence_refs":["evidence:project:fixture"],"action_refs":[],"result":{"markdown":"Read-only analysis for Beta."},"safety_flags":{"copy_only":true,"write_back_allowed":false,"command_execution_allowed":false,"script_execution_allowed":false,"mutation_allowed":false,"hidden_task_state_created":false,"raw_prompt_persisted":false,"raw_response_persisted":false,"raw_trace_persisted":false}},"output_text":"Read-only analysis for Beta.","draft_copy_only":true,"raw_prompt_persisted":false,"raw_response_persisted":false,"write_back_allowed":false,"script_execution_allowed":false,"audit_metadata":{"request_id":"audit-prompt-1","status":"succeeded","provider":"openai-compatible","model":"gpt-5","destination_host":"llm.example.com","redaction_applied":true,"raw_prompt_persisted":false,"raw_response_persisted":false,"input_tokens":240,"output_tokens":80},"readback":{"action_id":"prompt-preview-beta","source_revision":"sha256:prompt-beta-after","project_id":"project-fixture","domains":["provider_activity","prompt_runs"],"target_ids":["prompt-preview-beta"],"observations":[{"domain":"provider_activity","target_id":"prompt-preview-beta","revision":"sha256:activity-after"},{"domain":"prompt_runs","target_id":"prompt-preview-beta","revision":"sha256:prompt-run-after"}],"verified":true}}}'
            fi
          ...
          *\\"batch.applySkillToggles\\"*)
            if [ "$scenario" = "batch-mixed" ]; then
              respond '{"id":"test","ok":true,"result":{"action":{"id":"batch-preview-1","kind":"toggle_skill","intent":"disable_skill","target":{"kind":"skill","id":"alpha,gamma","scope":"agent-global"},"project_id":null,"impacts":["app_local_data","agent_config"],"preview_method":"batch.previewSkillToggles","apply_method":"batch.applySkillToggles","source_revision":"sha256:batch-fixture","confirmation_required":true,"network":"none","readback":["catalog_skills","agent_config","config_snapshots"],"evidence_refs":["skill:alpha","skill:gamma"]},"updated_count":2,"skipped_count":2,"snapshot_ids":["snap-claude-new","snap-codex"],"readback":{"action_id":"batch-preview-1","source_revision":"sha256:batch-readback","project_id":null,"domains":["catalog_skills","agent_config","config_snapshots"],"target_ids":["alpha","config:batch","snap-claude-new","snap-codex"],"observations":[{"domain":"agent_config","target_id":"config:batch","revision":"sha256:config-after"},{"domain":"catalog_skills","target_id":"alpha","revision":"sha256:catalog-after"},{"domain":"config_snapshots","target_id":"snap-claude-new","revision":"sha256:snapshot-claude-after"},{"domain":"config_snapshots","target_id":"snap-codex","revision":"sha256:snapshot-codex-after"}],"verified":true}}}'
            elif [ "$scenario" = "toggle-disabled" ] || [ "$scenario" = "stale-after-toggle" ]; then
              respond '{"id":"test","ok":true,"result":{"action":{"id":"single-toggle-beta","kind":"toggle_skill","intent":"disable_skill","target":{"kind":"skill","id":"beta","agent":"claude-code","scope":"agent-project"},"project_id":"project-fixture","impacts":["app_local_data","agent_config"],"preview_method":"batch.previewSkillToggles","apply_method":"batch.applySkillToggles","source_revision":"sha256:beta-fixture","confirmation_required":true,"network":"none","readback":["catalog_skills","agent_config","config_snapshots"],"evidence_refs":["skill:beta"]},"updated_count":1,"skipped_count":0,"snapshot_ids":["snap-single"],"readback":{"action_id":"single-toggle-beta","source_revision":"sha256:beta-readback","project_id":"project-fixture","domains":["catalog_skills","agent_config","config_snapshots"],"target_ids":["beta","config:beta","snap-single"],"observations":[{"domain":"agent_config","target_id":"config:beta","revision":"sha256:config-after"},{"domain":"catalog_skills","target_id":"beta","revision":"sha256:catalog-after"},{"domain":"config_snapshots","target_id":"snap-single","revision":"sha256:snapshot-after"}],"verified":true}}}'
            elif [ "$scenario" = "toggle-codex-disabled" ]; then
              respond '{"id":"test","ok":true,"result":{"action":{"id":"single-toggle-gamma","kind":"toggle_skill","intent":"disable_skill","target":{"kind":"skill","id":"gamma","agent":"codex","scope":"agent-global"},"project_id":null,"impacts":["app_local_data","agent_config"],"preview_method":"batch.previewSkillToggles","apply_method":"batch.applySkillToggles","source_revision":"sha256:gamma-fixture","confirmation_required":true,"network":"none","readback":["catalog_skills","agent_config","config_snapshots"],"evidence_refs":["skill:gamma"]},"updated_count":1,"skipped_count":0,"snapshot_ids":["snap-single"],"readback":{"action_id":"single-toggle-gamma","source_revision":"sha256:gamma-readback","project_id":null,"domains":["catalog_skills","agent_config","config_snapshots"],"target_ids":["config:gamma","gamma","snap-single"],"observations":[{"domain":"agent_config","target_id":"config:gamma","revision":"sha256:config-after"},{"domain":"catalog_skills","target_id":"gamma","revision":"sha256:catalog-after"},{"domain":"config_snapshots","target_id":"snap-single","revision":"sha256:snapshot-after"}],"verified":true}}}'
            elif [ "$scenario" = "opencode" ]; then
              respond '{"id":"test","ok":true,"result":{"action":{"id":"single-toggle-omega","kind":"toggle_skill","intent":"disable_skill","target":{"kind":"skill","id":"omega","agent":"opencode","scope":"agent-global"},"project_id":null,"impacts":["app_local_data","agent_config"],"preview_method":"batch.previewSkillToggles","apply_method":"batch.applySkillToggles","source_revision":"sha256:omega-fixture","confirmation_required":true,"network":"none","readback":["catalog_skills","agent_config","config_snapshots"],"evidence_refs":["skill:omega"]},"updated_count":1,"skipped_count":0,"snapshot_ids":["snap-single"],"readback":{"action_id":"single-toggle-omega","source_revision":"sha256:omega-readback","project_id":null,"domains":["catalog_skills","agent_config","config_snapshots"],"target_ids":["config:omega","omega","snap-single"],"observations":[{"domain":"agent_config","target_id":"config:omega","revision":"sha256:config-after"},{"domain":"catalog_skills","target_id":"omega","revision":"sha256:catalog-after"},{"domain":"config_snapshots","target_id":"snap-single","revision":"sha256:snapshot-after"}],"verified":true}}}'
            fi
          ...
          *\\"project.previewSetContext\\"*)
            if [ "$scenario" = "project-validation-error" ]; then
              ...
              project_set_action=$project_action_set_invalid
            else
              project_set_candidate=$project_active
              project_set_action=$project_action_set
            fi
            respond '{"id":"test","ok":true,"result":{"action":'"$project_set_action"',"preconditions":[{"kind":"project_context","target_id":"project-context","expected_revision":"sha256:project-before"}],"preview_token":"action-preview:v1:hmac-sha256:project-set","current":{"revision":"sha256:project-before","active":'"$project_active"',"recent":'"$project_recent"'},"candidate":{"revision":"sha256:project-set","active":'"$project_set_candidate"',"recent":['"$project_set_candidate"']},"affected_count":1}}'
            ;;
          *\\"project.setContext\\"*)
            if [ "$scenario" = "project-validation-error" ]; then
              project_set_state=$project_invalid
              project_set_action=$project_action_set_invalid
              project_set_id=project-missing
            else
              project_set_state=$project_active
              project_set_action=$project_action_set
              project_set_id=project-1
            fi
            respond '{"id":"test","ok":true,"result":{"action":'"$project_set_action"',"preview_token":"action-preview:v1:hmac-sha256:project-set","state":{"revision":"sha256:project-set","active":'"$project_set_state"',"recent":['"$project_set_state"']},"affected_count":1,"readback":{"action_id":"action:set-project","source_revision":"sha256:project-set-readback","project_id":"'"$project_set_id"'","domains":["project_context"],"target_ids":["project-context"],"observations":[{"domain":"project_context","target_id":"project-context","revision":"sha256:project-set"}],"verified":true}}}'
            ;;
          ...
          *\\"skill.listEventsPage\\"*)
            if [ "$scenario" = "detail-scope" ]; then
              case "$input" in
                *\\"instance_id\\":\\"beta\\"*)
                  respond '{"id":"test","ok":true,"result":{"records":'"$events_beta"',"source_revision":"sha256:events-beta","returned_count":2,"total_count":2,"has_more":false,"next_cursor":null,"source_completeness":"enumerable","incomplete_reason":null}}'
                  ;;
                *\\"instance_id\\":\\"gamma\\"*)
                  respond '{"id":"test","ok":true,"result":{"records":'"$events_gamma"',"source_revision":"sha256:events-gamma","returned_count":1,"total_count":1,"has_more":false,"next_cursor":null,"source_completeness":"enumerable","incomplete_reason":null}}'
                  ;;
              esac
            fi
            respond '{"id":"test","ok":true,"result":{"records":[],"source_revision":"sha256:empty-events","returned_count":0,"total_count":0,"has_more":false,"next_cursor":null,"source_completeness":"enumerable","incomplete_reason":null}}'
            ;;
          ...
          *\\"config.saveClaudeSettings\\"*)
            if [ "$scenario" = "config-cas" ] || [ "$scenario" = "config-save-snapshot-refresh-fails" ]; then
              respond '{"id":"test","ok":true,"result":{"action":'"$config_save_action"',"document":{"agent":"claude-code","scope":"agent-global","target":"/tmp/home/.claude/settings.json","format":"json","content":"{\\"theme\\":\\"dark\\"}\\n","exists":true,"revision":"sha256:saved-revision"},"snapshot_id":"snapshot-config-save","readback":{"action_id":"action:save_config:global","source_revision":"sha256:saved-revision","project_id":null,"domains":["catalog_skills","skill_aggregates","agent_config","config_snapshots"],"target_ids":["agent:claude-code:catalog-skills","agent:claude-code:skill-aggregates","/tmp/home/.claude/settings.json","snapshot-config-save"],"observations":[{"domain":"catalog_skills","target_id":"agent:claude-code:catalog-skills","revision":"sha256:catalog-skills-saved"},{"domain":"skill_aggregates","target_id":"agent:claude-code:skill-aggregates","revision":"sha256:skill-aggregates-saved"},{"domain":"agent_config","target_id":"/tmp/home/.claude/settings.json","revision":"sha256:saved-revision"},{"domain":"config_snapshots","target_id":"snapshot-config-save","revision":"sha256:snapshot-config-save"}],"verified":true}}}'
            ...
            if [ "$scenario" = "config-cas" ]; then
              case "$input" in
                *\\"snapshot_id\\":\\"snap-claude-new\\"*\\"preview_token\\":\\"action-preview:v1:hmac-sha256:rollback-preview\\"*|*\\"preview_token\\":\\"action-preview:v1:hmac-sha256:rollback-preview\\"*\\"snapshot_id\\":\\"snap-claude-new\\"*)
                  respond '{"id":"test","ok":true,"result":{"action":'"$rollback_action_global"',"snapshot_id":"snap-claude-new","document":{"agent":"claude-code","scope":"agent-global","target":"/tmp/home/.claude/settings.json","format":"json","content":"{}\\n","exists":true,"revision":"sha256:rollback-restored"},"readback":{"action_id":"action:rollback_config:global","source_revision":"sha256:rollback-restored","project_id":null,"domains":["catalog_skills","skill_aggregates","agent_config"],"target_ids":["agent:claude-code:catalog-skills","agent:claude-code:skill-aggregates","/tmp/home/.claude/settings.json"],"observations":[{"domain":"catalog_skills","target_id":"agent:claude-code:catalog-skills","revision":"sha256:catalog-skills-rollback"},{"domain":"skill_aggregates","target_id":"agent:claude-code:skill-aggregates","revision":"sha256:skill-aggregates-rollback"},{"domain":"agent_config","target_id":"/tmp/home/.claude/settings.json","revision":"sha256:rollback-restored"}],"verified":true}}}'
                  ;;
                *\\"snapshot_id\\":\\"snap-claude-old\\"*\\"preview_token\\":\\"action-preview:v1:hmac-sha256:rollback-preview-2\\"*|*\\"preview_token\\":\\"action-preview:v1:hmac-sha256:rollback-preview-2\\"*\\"snapshot_id\\":\\"snap-claude-old\\"*)
                  respond '{"id":"test","ok":true,"result":{"action":'"$rollback_action_project"',"snapshot_id":"snap-claude-old","document":{"agent":"claude-code","scope":"agent-project","target":"/tmp/project/.claude/settings.local.json","format":"json","content":"{}\\n","exists":true,"revision":"sha256:rollback-restored-2"},"readback":{"action_id":"action:rollback_config:project","source_revision":"sha256:rollback-restored-2","project_id":"project-fixture","domains":["catalog_skills","skill_aggregates","agent_config"],"target_ids":["agent:claude-code:catalog-skills","agent:claude-code:skill-aggregates","/tmp/project/.claude/settings.local.json"],"observations":[{"domain":"catalog_skills","target_id":"agent:claude-code:catalog-skills","revision":"sha256:catalog-skills-rollback-2"},{"domain":"skill_aggregates","target_id":"agent:claude-code:skill-aggregates","revision":"sha256:skill-aggregates-rollback-2"},{"domain":"agent_config","target_id":"/tmp/project/.claude/settings.local.json","revision":"sha256:rollback-restored-2"}],"verified":true}}}'
                  ;;
              esac
          ...
          *\\"snapshot.listAgentConfigPage\\"*)
            ...
            if [ "$scenario" = "timeline" ] || [ "$scenario" = "config-cas" ] || [ "$scenario" = "config-save-stale" ] || [ "$scenario" = "config-save-readback-mismatch" ] || [ "$scenario" = "config-save-snapshot-refresh-fails" ] || [ "$scenario" = "rollback-stale" ] || [ "$scenario" = "rollback-preview-delay" ] || [ "$scenario" = "protocol-v1-bindings" ] || [ "$scenario" = "protocol-v2-missing-bindings" ]; then
              case "$input" in
                *\\"agent\\":\\"claude-code\\"*)
                  respond '{"id":"test","ok":true,"result":{"records":'"$snapshots_claude"',"source_revision":"sha256:snapshots-claude","returned_count":2,"total_count":2,"has_more":false,"next_cursor":null,"source_completeness":"enumerable","incomplete_reason":null}}'
                  ;;
                *\\"agent\\":\\"codex\\"*)
                  respond '{"id":"test","ok":true,"result":{"records":'"$snapshots_codex"',"source_revision":"sha256:snapshots-codex","returned_count":1,"total_count":1,"has_more":false,"next_cursor":null,"source_completeness":"enumerable","incomplete_reason":null}}'
                  ;;
                *\\"agent\\":\\"opencode\\"*)
                  respond '{"id":"test","ok":true,"result":{"records":'"$snapshots_opencode"',"source_revision":"sha256:snapshots-opencode","returned_count":1,"total_count":1,"has_more":false,"next_cursor":null,"source_completeness":"enumerable","incomplete_reason":null}}'
                  ;;
              esac
            fi
            respond '{"id":"test","ok":true,"result":{"records":[],"source_revision":"sha256:empty-snapshots","returned_count":0,"total_count":0,"has_more":false,"next_cursor":null,"source_completeness":"enumerable","incomplete_reason":null}}'
            ;;
          *\\"snapshot.list\\"*)
            respond '{"id":"test","ok":true,"result":[]}'
            ;;
