...
struct SkillStoreTests {
    ...
    private func providerActivityAccumulatesAllPagesWithoutChangingSummary() async throws {
    ...
    private func providerActivityCancellationAndStaleGenerationPreserveAcceptedRows() async throws {
